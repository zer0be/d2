    ...
    if(!empty($_POST))
    {
        ...
        if($row)
        {
            ...
            if($check_password === $row['password'])
            {
                ...
                $_SESSION["errorcode"][] = "Incorrect Password. Please try again. If the problem persists, contact me at support@d2etracker.com or through the FFG Forums <a href='https://community.fantasyflightgames.com/user/239371-atom4gevampire/'>here</a>.";
            }
        } else {
            $_SESSION["errorcode"][] = "Incorrect Username. Make sure you used the <strong>username</strong> you have registered with, not the e-mail address.";
        }
    ...
    <body>
        ...
        <div class="container grey">
            <div class="row">
                <div class="col-sm-12">
                    <h1>Log In</h1>
                    <p class="top-lead lead text-muted">Log in to your account on the d2etracker website.</p><?php
                ...
                <div class="col-sm-6">
                    ...
                    <form action="login.php" method="post" class="form-horizontal text-margin-10">
