...
<div class="row">
    <?php do { 
      ...
      <div class="col-md-2 col-sm-4 col-xs-4">
        <a class="thumbnail" href="#"><img src="img/campaigns/logos/<?php echo $short; ?>.jpg" /></a>
      </div>
        ...
        foreach ($gamingGroups as $gg) { 
          if ($xg <= 10) { ?>
            <div class="row campaign-row">
              ...
              <div class="col-sm-3">
                <span class="visible-xs-inline"><strong>Location: </strong></span><?php echo htmlentities($gg['grp_city'], ENT_QUOTES, 'UTF-8') . ", " . htmlentities($gg['grp_state_country'], ENT_QUOTES, 'UTF-8'); ?>
              </div>
...
<div class="row">
  <div class="col-sm-12 text-center">
    <small class="text-muted">
      ...
      <p>I would like to thank the following people for their help during development of this this site: <br />
